...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    redirect(BASE_URL . '/marinka/treatments.php');
}
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= e(BASE_URL) ?>/marinka/treatment-form.php" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i>Add Treatment</a>
</div>
    ...
    <table class="table align-middle">
      ...
      <?php foreach ($treatments as $t): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="<?= e(BASE_URL) ?>/marinka/treatment-form.php?id=<?= (int)$t['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
