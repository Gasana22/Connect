...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    redirect(BASE_URL . '/marinka/partners.php');
}
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= e(BASE_URL) ?>/marinka/partner-form.php" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i>Add Partner</a>
</div>
    ...
    <table class="table align-middle">
      ...
      <?php foreach ($partners as $p): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="<?= e(BASE_URL) ?>/marinka/partner-form.php?id=<?= (int)$p['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
