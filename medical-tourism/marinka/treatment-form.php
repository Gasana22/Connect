...
<form method="post" enctype="multipart/form-data" class="stat-card bg-white p-4">
  ...
  <div class="row g-3">
    ...
    <div class="col-md-6">
      ...
      <div class="form-text">Need a new one? <a href="<?= e(BASE_URL) ?>/marinka/categories.php" target="_blank">Manage categories</a>.</div>
    </div>
    <div class="col-12">
  ...
  <a href="<?= e(BASE_URL) ?>/marinka/treatments.php" class="btn btn-outline-secondary rounded-pill px-4">Cancel</a>
</form>
