...
<div class="row g-4 mb-4">
  <div class="col-md-4">
    <div class="stat-card bg-white p-4 text-center">
      ...
      <a href="<?= e(BASE_URL) ?>/marinka/treatments.php" class="small">Manage &rarr;</a>
    </div>
  </div>
  <div class="col-md-4">
    <div class="stat-card bg-white p-4 text-center">
      ...
      <a href="<?= e(BASE_URL) ?>/marinka/hospitals.php" class="small">Manage &rarr;</a>
    </div>
  </div>
  <div class="col-md-4">
    <div class="stat-card bg-white p-4 text-center">
      ...
      <a href="<?= e(BASE_URL) ?>/marinka/packages.php" class="small">Manage &rarr;</a>
    </div>
  </div>
</div>
  ...
  <div class="col-lg-5">
    <div class="stat-card bg-white p-4 h-100">
      ...
      <div class="d-grid gap-2">
        <a href="<?= e(BASE_URL) ?>/marinka/treatment-form.php" class="btn btn-outline-primary text-start"><i class="bi bi-plus-circle me-2"></i>Add Treatment</a>
        <a href="<?= e(BASE_URL) ?>/marinka/package-form.php" class="btn btn-outline-primary text-start"><i class="bi bi-plus-circle me-2"></i>Add Package</a>
        <a href="<?= e(BASE_URL) ?>/marinka/blog-form.php" class="btn btn-outline-primary text-start"><i class="bi bi-plus-circle me-2"></i>Write Blog Post</a>
        <a href="<?= e(BASE_URL) ?>/marinka/leads.php" class="btn btn-outline-primary text-start"><i class="bi bi-inbox me-2"></i>Review New Leads</a>
      </div>
    </div>
  </div>
</div>
...
<div class="stat-card bg-white p-4 mt-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= e(BASE_URL) ?>/marinka/leads.php" class="small">View all &rarr;</a>
  </div>
  <div class="table-responsive">
    <table class="table align-middle">
      ...
      <tbody>
        ...
        <tr>
          <td><a href="<?= e(BASE_URL) ?>/marinka/lead-view.php?id=<?= (int)$lead['id'] ?>"><?= e($lead['full_name']) ?></a></td>
          <td><?= e($lead['email']) ?></td>
