...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (in_array($status, ['new', 'contacted', 'converted', 'closed'], true)) {
        ...
        redirect(BASE_URL . '/marinka/lead-view.php?id=' . $id);
    }
}
...
<a href="<?= e(BASE_URL) ?>/marinka/leads.php" class="d-inline-block mb-3 small"><i class="bi bi-arrow-left"></i> Back to all leads</a>
