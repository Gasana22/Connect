...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= e(BASE_URL) ?>/admin/doctor-form.php" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i>Add Doctor</a>
</div>
    ...
    <table class="table align-middle">
      ...
      <?php foreach ($doctors as $doc): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="<?= e(BASE_URL) ?>/admin/doctor-form.php?id=<?= (int)$doc['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
