...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= e(BASE_URL) ?>/admin/destination-form.php" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i>Add Destination</a>
</div>
    ...
    <table class="table align-middle">
      ...
      <?php foreach ($destinations as $d): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="<?= e(BASE_URL) ?>/admin/destination-form.php?id=<?= (int)$d['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
