...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= e(BASE_URL) ?>/admin/hospital-form.php" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i>Add Hospital</a>
</div>
    ...
    <table class="table align-middle">
      ...
      <?php foreach ($hospitals as $h): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="<?= e(BASE_URL) ?>/admin/hospital-form.php?id=<?= (int)$h['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
