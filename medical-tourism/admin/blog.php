...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <a href="<?= e(BASE_URL) ?>/admin/blog-form.php" class="btn btn-primary rounded-pill"><i class="bi bi-plus-lg me-1"></i>Write New Post</a>
</div>
    ...
    <table class="table align-middle">
      ...
      <?php foreach ($posts as $post): ?>
        <tr>
          ...
          <td class="text-end">
            <a href="<?= e(BASE_URL) ?>/admin/blog-form.php?id=<?= (int)$post['id'] ?>" class="btn btn-sm btn-outline-primary"><i class="bi bi-pencil"></i></a>
