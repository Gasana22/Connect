...
$pageTitle = e($profile['username']) . "'s following";
include __DIR__ . '/includes/layout_header.php';
?>
<h1 style="margin-bottom: 1.5rem;"><?= e($profile['username']) ?> follows</h1>
<?php if (!$rows): ?>
  <div class="empty-state"><i class="fas fa-user-slash"></i><h3>Not following anyone yet</h3></div>
<?php else: ?>
